namespace Byndyusoft.ML.Tools.Metrics.Settings
{
    ...
    {
        /// <summary>
        ///     Минимальное значение настройки максимального количеству точек на графике. <see cref="MaxDataPointsCountInCurve" />>
        /// </summary>
        ...
        /// </summary>
        public static PrecisionRecallCurveSettings Default()
        {
        ...
        /// </summary>
        public bool CurveShouldBeReduced()
        {
